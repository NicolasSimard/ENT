...
sub(i) = intnum(x = -1/2, 1/2,intnum(y = (1-x^2)^(1/2),[[1],4*Pi],norm(delta5((x+y*I)/(i*(x+y*I)+1))*(i*(x+I*y)+1)^-k)*y^(k-2)));

sub0 = intnum(x = -1/2, 1/2,intnum(y = (1-x^2)^(1/2),[[1],4*Pi],norm(delta5(-1/(x+y*I))*(x+I*y)^-k)*y^(k-2)));
